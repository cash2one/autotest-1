...
DATABASES = {
    'default': {
        ...
        'USER': 'lili',                      # Not used with sqlite3.
        'PASSWORD': 'lili',                  # Not used with sqlite3.
        'HOST': 'tb085x.corp.youdao.com',                      # Set to empty string for localhost. Not used with sqlite3.
...
##此处{%get_media_prefix%}用来获取hostname，因为MEDIA_URL没有具体定义
MEDIA_URL = ''
